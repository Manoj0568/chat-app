  ...
  return (
    ...
    <form className='p-2 my-2' onSubmit={handleSubmit}>
        <div className='w-full relative'>
            ...
            placeholder='type here....' value={message} onChange={(e)=>setMessage(e.target.value)} />

            <button type='submit' className='absolute inset-y-0 end-0 flex items-center pe-3'>
             {loading?<span className='loading loading-spinner'></span>:<IoSend className='text-white'/>}
            </button>
